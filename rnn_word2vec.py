...
class SeriesPredictor:
    def __init__(self, input_dim, seq_size, hidden_dim=10):
        ...
        self.x = tf.placeholder(tf.float32, [128, seq_size, input_dim])
        self.y = tf.placeholder(tf.float32, [128, seq_size])
...
with tf.Session() as session:
  ...
  data = normalized_embeddings.eval()

seq_size = 5
predictor = SeriesPredictor(input_dim=128, seq_size=seq_size, hidden_dim=100)
